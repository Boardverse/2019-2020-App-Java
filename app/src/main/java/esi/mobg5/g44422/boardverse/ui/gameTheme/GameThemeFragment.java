package esi.mobg5.g44422.boardverse.ui.gameTheme;
...
public class GameThemeFragment extends Fragment {
    ...
    private GameThemeFragmentViewModel mViewModel;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(GameThemeFragmentViewModel.class);
